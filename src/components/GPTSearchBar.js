  ...
  return (
    <div className="pt-[10%] flex justify-center">
      ...
      >
        ...
        ></input>
        <button
          className="py-2 px-4 m-4 text-white bg-red-600 rounded-sm col-span-3 font-medium"
      ...
      {
         movieInfo && movieInfo.length > 0 && <div className="bg-black bg-opacity-80">
           <button className="py-2 px-6 m-4 text-white bg-red-600 rounded-sm font-medium" onClick={handleClearClick}>Clear</button>
        </div>
      }
